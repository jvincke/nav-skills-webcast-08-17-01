    ...
    private runObjectOnLine(line: TextLine, publish: boolean) {
        if (line != null && line.text != null) {
            ...
            if (lowertext.startsWith('page ') || lowertext.startsWith('report')) {
                ...
                window.showErrorMessage('Did not find a page or report object in the current line. Are you at the first line of a page or report or is the first line valid?')
            }
        }
    }
}